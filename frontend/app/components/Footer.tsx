      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-black/50 text-base hover:text-black active:text-black transition-colors hover:-translate-x-1 inline-block"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-black/50 text-base">
