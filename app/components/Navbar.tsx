      ...
      <div className="w-full px-6 md:px-12 lg:px-20">
        <div className="flex items-center justify-between py-2 md:py-3">
          ...
          <div className="hidden md:block">
            <button className="bg-gradient-to-r from-blue-600 to-blue-400 px-5 py-2 rounded-full shadow-[0_0_20px_rgba(59,130,246,0.4)] transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.7)] hover:scale-105 hover:from-blue-500 hover:to-cyan-400 active:scale-95 active:shadow-[0_0_30px_rgba(59,130,246,0.7)]">
              Let’s Talk →
            </button>
          </div>
          <button
          ...
          <div className="md:hidden mt-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 flex flex-col gap-4 text-gray-300 animate-in fade-in slide-in-from-top-2 duration-300">
            {navLinks.map(({ name, href }) => (
              <Link
                key={name}
                href={href}
                className="hover:text-white active:text-white hover:translate-x-1 active:translate-x-1 transition-all duration-200 cursor-pointer"
              >
                {name}
              </Link>
            ))}
            <button className="mt-4 bg-gradient-to-r from-blue-600 to-blue-400 py-2 rounded-full transition-all duration-300 hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] hover:scale-[1.02] active:scale-95 active:shadow-[0_0_25px_rgba(59,130,246,0.6)]">
              Let’s Talk →
            </button>
          </div>
        )}
